...
```
  ...
  -o, --output string              The output image, the extension determine the image format, raw will be used if none. Supported formats: qcow2 qed raw vdi vhdx vmdk vpc (default "disk0.qcow2")
